...
const LendingManager = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get('https://library.library-os.workers.dev/api/borrows', config);
  ...
  const handleReturn = async (id) => {
    ...
    try {
      await axios.put(`https://library.library-os.workers.dev/api/borrows/${id}/return`, {}, config);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://library.library-os.workers.dev/api/borrows/${id}`, config);
